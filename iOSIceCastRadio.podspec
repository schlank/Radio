#
#  Be sure to run `pod spec lint iOSIceCastRadio.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "iOSIceCastRadio"
  s.version      = "0.0.1"
  s.summary      = "Radio is an open-source wrapper to play Icecast Internet radio stations on iOS."
...
* Uses iOS7 audio APIs
  ...
  s.homepage     = "https://github.com/schlank/iOSIceCastRadio"
  ...
  s.author             = { "Phil Leder" => "phil@philipleder.com" }
  # Or just: s.author    = "Phil Leder"
  # s.authors            = { "Phil Leder" => "phil@philipleder.com" }
  # s.social_media_url   = "http://philipleder.com"
  ...
  #s.source       = { :git => "https://github.com/schlank/iOSIceCastRadio", :tag => "0.0.1" }
